                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500">{{ old('description', $product->description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-lg shadow-sm">
                                    ...
                                    <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $product->price) }}" min="0" required
                                           class="block w-full pl-7 rounded-lg border-gray-300 focus:border-yellow-500 focus:ring-yellow-500">
                                </div>
                            </div>
